      ...
      <section className="privacy-policy">
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Investigating fraud that has already taken place. The information
              is not provided to those organizations for advertising purposes.
            </li>
          </ul>
        </section>
        <section>
          ...
          <h3>
            ...
            Control
            <br />
            NMT Solutions also allows users to control their data if users want
            to modify, delete or access it. Users can request to review, update,
